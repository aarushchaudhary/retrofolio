    ...
    >
      <div className="relative mx-auto flex max-w-5xl flex-col gap-8 md:flex-row md:items-center md:gap-12">
        ...
        <div className="flex-1">
          ...
          {/* Title */}
          <h1 className="retro mb-4 font-bold text-3xl tracking-tight md:text-5xl text-primary drop-shadow-[4px_4px_0_theme('colors.foreground')]">
            {title}
          </h1>

          {/* Subtitle */}
          {subtitle && (
            <p className="retro mb-4 text-secondary-foreground font-bold text-xs md:text-sm uppercase bg-secondary inline-block px-3 py-1 border-2 border-foreground shadow-[2px_2px_0_theme('colors.foreground')]">
              {subtitle}
            </p>
          )}
          ...
          {/* Description */}
          {description && (
            <p className="mb-8 text-foreground text-sm leading-relaxed max-w-lg mt-6">
              {description}
            </p>
          )}
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          {visual ? (
            ...
            <div className="w-full max-w-sm aspect-square border-4 border-foreground shadow-[8px_8px_0_theme('colors.primary.DEFAULT')] overflow-hidden bg-secondary relative">
