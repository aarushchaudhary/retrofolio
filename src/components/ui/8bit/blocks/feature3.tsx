            ...
            {items.map((item) => (
              ...
              >
                <div className="h-full p-2 md:p-4">
                  <Card className="relative h-full min-h-[280px] border-4 border-foreground bg-background shadow-[6px_6px_0_theme('colors.foreground')] hover:-translate-y-1 transition-transform duration-200">
                  {item.badge && (
